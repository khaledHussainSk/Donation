...
public class FollowingActivity extends AppCompatActivity {
        ...
        FirebaseFirestore.getInstance().collection("Friends")
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for (QueryDocumentSnapshot queryDocumentSnapshot : task.getResult()) {
                    ...
                    if (id_user != null){
                        if (friend.getId_following().equals(id_user)){
                            getUser(friend);
                        }
                    }else {
                        if (friend.getId_following().equals(currentUserID)){
                            getUser(friend);
                        }
                    }
    ...
    private void getUser(Friend friend) {
        FirebaseFirestore.getInstance().collection("Users").document(friend.getId_follower())
                .get()
