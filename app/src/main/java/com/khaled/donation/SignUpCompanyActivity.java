...
public class SignUpCompanyActivity extends AppCompatActivity {
    ...
    Calendar calendar;
    Uri imageUri;
    String companyName,email,password,phoneNumber,address,confirmPassword,image;
    User user;
        ...
        binding.ivCam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CropImage.activity()
                        ...
                        .start(SignUpCompanyActivity.this);
    ...
    private void getInfo(){
        ...
        if (imageUri != null){
            ...
            storage.getReference()
                    .child("companiesImages/"+Calendar.getInstance().getTime()).putFile(imageUri)
                        ...
                        if (task.isSuccessful()){
                            ...
                            documentReference
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        binding.spinKit.setVisibility(View.GONE);
                                                Intent intent =
                                                        new Intent(SignUpCompanyActivity.this
    ...
    private void enableField(){
        ...
        binding.etCompanyName.setEnabled(true);
